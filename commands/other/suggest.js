...
module.exports = {
	...
	do: async (locale, message, client, args, Discord) => {
		...
		if (qServerDB.config.mode === "review") {
			...
			embedReview.addField(string(locale, "APPROVE_DENY_HEADER"), string(guildLocale, "REVIEW_COMMAND_INFO", { prefix: qServerDB.config.prefix, id: id.toString(), channel: `<#${qServerDB.config.channels.suggestions}>` }));
