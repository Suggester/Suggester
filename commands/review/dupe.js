...
module.exports = {
	...
	do: async (locale, message, client, args, Discord) => {
		...
		if (dupeSuggestion.status !== "awaiting_review") {
			switch (dupeSuggestion.status) {
			case "approved":
		...
		await notifyFollowers(client, qServerDB, dupeSuggestion, "red", { string: "DENIED_DM_TITLE", guild: message.guild.name }, dupeSuggestion.attachment, null,{ header: "REASON_GIVEN", reason: dupeSuggestion.denial_reason });
